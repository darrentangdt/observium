...
class HtmlIncludesFunctionsTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function providerGenerateQueryValues()
  {
    return array(
      ...
      array(NULL,                       '`test`',   'LIKE', " AND (ISNULL(`test`, '') LIKE '')"),
      array('',                         '`test`',   'LIKE', " AND (ISNULL(`test`, '') LIKE '')"),
      ...
      array(NULL,                       '`test`', 'NOT LIKE', " AND (ISNULL(`test`, '') NOT LIKE '')"),
      array('',                         '`test`', 'NOT LIKE', " AND (ISNULL(`test`, '') NOT LIKE '')"),
